...
module.exports.run = async function({ api, event }) {
  ...
  request(encodeURI(randomLink))
    ...
    .on("close", () => {
      api.sendMessage({
        body: "পাপির দল 😤 বেশি দেখিস‌ না 🥵 হয়তো আবার হাত মেরে ফেলবি🫵 3X hot video for♥⃝ꕀ⃘⃜⃟ؖؖؖؖؖؖؖؖؖꙮ͌͌͌͌͌͌͌͌͌͌͌͌͌͌ ꕀ⃘⃜⃟ؖؖؖؖؖؖؖؖؖ.  BͥEͥLͥAͥLͥBͥOͥTͥ Xͥ6ͥ6ͥ6ꕀ⃘⃜⃟ؖؖؖؖؖؖؖؖؖꙮ͌͌͌͌͌͌͌͌͌͌͌͌͌͌ꕀ⃘⃜⃟ؖؖؖؖؖؖؖؖؖꔹ⃟ꔹ⃟♥⃝✡️",
