...
module.exports.handleEvent = async ({ api, event, Threads }) => {
 ...
 if (body.startsWith("🙄")) {
 const rahad = [
 "╭•┄┅════❁✡️❁════┅┄•╮\n \n🙂 একতরফা ভালোবাসা নট অ্যালাও 🚫 তুমি যাকে যতটুক ভালবাসবে তার কাছ থেকে ততটুক ভালোবাসা পাওয়াই উচিত 😅 ভালোবাসা সুন্দর কিন্তু মানুষটা খাঁটি হতে হবে 🥹 🚫✦─⃝‌‌𝔹𝔼𝕃𝔸𝕃 𝔹𝕆𝕋 ✡️✦\n\n╰•┄┅════❁✡️❁════┅┄•╯",
 "╭•┄┅════❁✡️❁════┅┄•╮\n\n 🙂 যে তোমাকে ভালোবাসে না তার পিছনে পড়ে থেকো না 😅 যে তোমাকে সত্যিকারের ভালবাসে তুমি তার পিছনে চুটো 🙂 ভালোবাসা সুন্দর যদি মানুষটা কাটি হয় 🫶❤️🚫✦─꯭─⃝‌‌𝔹𝔼𝕃𝔸𝕃 𝔹𝕆𝕋 ✡️✦\n\n╰•┄┅════❁✡️❁════┅┄•╯"
