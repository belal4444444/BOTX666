...
module.exports.handleEvent = async ({ event, api }) => {
  ...
  const sensitiveKeywords = ["i will kill you", "i will stab you", "kill you", "stab you", " বাঞ্চুদ", "bancud", "madarcud", "মাদারচোদ", "make cudi", "মাকে চুদি", " bl",  "sawya", " সাওয়া", "হাউয়া", " সাউয়া", " hauya", "tor mare cudi", " Tor mare cudi", "tor mare xudi", " Tor mare xudi", "তোর মারে চুদি", " আয় চুদি", "ay cudi", " ay xudi", " bessa", "Bessa", " মাগি", "নডি", " xudi", "cudi", " cuda", "xuda", " putki mara", "পুটকি মারা", " সোনা", "suna" "vuda", " vudi", "tor mar vuda", " ভুদা", "sex", " hot", "sexy", " xudmarani", "cudmarani", " vuda lal","madarxud", "magi baz", " bazar er khanki", "bassa magi", " noti magi", "kuttar bacha", " suorer bacca", "potita magi", " potita", "potitaloy", "khankir pula", "heda","হেডা","খামকির পুলা", "fuck you", "you idiot", "motherfucker"]; // Dagdagan mo lang kung gusto mong maraming keywords 
    ...
    if (message.includes(keyword)) {
      ...
      try {
        ...
        outputStream.on("finish", () => {
          const warningMessage = `╭•┄┅═❁🌺❁═┅┄•╮\n⚠️ 𝗪𝗔𝗥𝗡𝗜𝗡𝗚 ⚠️\n╰•┄┅═❁🌺❁═┅┄•╯\n\n⋆✦⋆⎯⎯⎯⎯⎯⎯⎯⋆✦⋆\n অনুগ্রহ করে সংবেদনশীল  অনুপযুক্ত অশ্লিল  ভাষা ব্যবহার করবেব না! 🤬 মেসেজটা রিমুভ করে ফেলেন নেক্সট টাইম এইরকম ভাষা ব্যবহার করলে ✡️ আপনার বিপদ হবে 🚫  ।\n\n  ☠️ 𝗨𝗦𝗘𝗥: ${userName}\n  🪪 𝗜𝗗: ${senderID}\n  💬 𝗠𝗦𝗚: ${keyword}`;
