...
try{
   const body = event.body ? event.body?.toLowerCase() : ""
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("বট") || body.startsWith("বেবি")) {
            const arr = body.replace(/^\S+\s*/, "")
        const randomReplies = ["আমাকে ডেকেছেন 🥲", "আমার সাথে কেউ কথা বলে না 😔", "আমি এই যে বলো সোনা তোমার জন্য কি করতে পারি 🥰", " হ্যাঁ বল শুনছি তো 😒","কি হয়েছে এত ডাকাডাকি করো কেনো 😤"," আমার বস চাঁদের পাহাড় কে একটা রিলেশন করাই দিলে তো সারা জীবনের রিচার্জ ফ্রি🙂✡️","তুই আমাকে ডাকিস না আমার বস চাঁদের পাহাড় তোকে পছন্দ করে না😒","কি হয়েছে বারবার ডাকো কেনো 😩"," হ্যাঁ বলো 🙂"," বারবার আমাকে ডেকে মজা নিচ্ছ তাই না 🙂"," একটা কথা শুনে রাখো আমাকে অসম্মান করলে আমার বস তোমাকে ছাড়বে না ✡️🙂"," হ্যাঁ বলো শুনছি তো কি করছো তুমি 🥰","হ্যাঁ বলো জানু কেমন আছো তুমি 🥳","ব্যাপার কি আপনি শ্বশুর বাড়ি যাচ্ছেন না কেনো🥴 ","তোমার কি কোন কাজবাজ নাই নাকি সারাদিন আমাকে ডাকো কেনো 😒😒"," আমাকে ডেকো না আমি এখন আমার বস চাঁদের পাহাড় এর  সাথে ব্যস্ত আছি 😤😤"," হ্যাঁ বলো জান খাবার খাইছো তুমি 🙃🫠",];
            if (!arr) {
