...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://ibb.co.com/RkMVJstZ/images-2022-08-14-T183542-356.jpg", path);
}
...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage(" মালিক চাঁদের পাহাড় আপনি শুধু মেনশন করেন ওই খানকির ছেলেরে উলঙ্গ করে আপনার উপরে বসিয়ে দেব 🪬.", threadID, messageID);
    else {
